...
class DataMLR:
    ...
    @staticmethod
    def getAllOfTheData():
        TrainX = DataMLR.placeDataIntoArray('Train-Data.csv')
        TrainY = DataMLR.placeDataIntoArray('Train-pIC50.csv')
        ValidateX = DataMLR.placeDataIntoArray('Validation-Data.csv')
        ValidateY = DataMLR.placeDataIntoArray('Validation-pIC50.csv')
        TestX = DataMLR.placeDataIntoArray('Test-Data.csv')
        TestY = DataMLR.placeDataIntoArray('Test-pIC50.csv')
